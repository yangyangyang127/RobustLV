...
def train(crossi, batch_size, epoch, learning_rate, device = torch.device("cuda")):
    ...
    pretrained_path = "params/{}_v45-0155d.pkl".format(cross_i)
    ...
    for e in range(0, epoch):
        ...
        if e > 2 and (e % 90 == 0 or e % 160 == 0 or e % 360 == 0 or e % 4350 == 0):
            lr = lr * 0.12
        ...
        if e % 5 == 0 and e > 80:
            ...
            file_path = os.path.join("params/", str(cross_i) + '_v45-{:04d}.pkl'.format(e))
            torch.save(dd, file_path)
            #torch.save(state, file_path)

if __name__ == "__main__":
    train(0, 50, 250, 0.0005, torch.device("cuda"))
